...
do_path_gen_plot(route,XY,N,R)   % calculates the path and then plots it 


z_s = [XY(1,1) XY(1,2) 0];
tr_s = create_transform_matrix(z_s);
plot_tractor(tr_s, 'g');

z_f = [XY(22,1) XY(22,2) -pi/2];
tr_f = create_transform_matrix(z_f);
plot_tractor(tr_f, 'r');
